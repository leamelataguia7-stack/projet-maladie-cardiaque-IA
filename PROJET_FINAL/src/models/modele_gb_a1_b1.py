# gb_A1_B1.py
# Objectif : entraîner un Gradient Boosting sur A1 (sans SMOTE) puis sur B1 (avec SMOTE).
...
print("=== Gradient Boosting sur A1 (sans SMOTE) ===")
...
# 3) Définition du modèle Gradient Boosting (GB_A1) ---------------------------

# Paramètres "raisonnables" pour un premier modèle :
# - n_estimators = 300 arbres faibles
# - learning_rate = 0.05 (plus petit = plus régulier)
# - max_depth = 3 (arbres peu profonds, typique du boosting)
...
print("\n=== Entraînement du Gradient Boosting sur A1 (sans SMOTE) ===")
gb_A1.fit(X_train_A1, y_train)
print(" Modèle GB_A1 entraîné.")

# 4) Prédictions sur le jeu de test (A1) -------------------------------------

y_prob_A1 = gb_A1.predict_proba(X_test_raw)[:, 1]
y_pred_A1 = (y_prob_A1 >= 0.5).astype(int)

print("\n=== Évaluation de GB_A1 sur le jeu de test ===")
...
print("\nRapport de classification (GB_A1) :")
...
print("\n=== Fin du bloc GB_A1 (sans SMOTE) ===")

# 5) Gradient Boosting sur B1 (avec SMOTE) -----------------------------------

print("\n=== Gradient Boosting sur B1 (avec SMOTE) ===")
...
print("\n=== Entraînement du Gradient Boosting sur B1 (avec SMOTE) ===")
gb_B1.fit(X_train_B1, y_train_B1)
print(" Modèle GB_B1 entraîné.")

# Prédictions sur le même test réaliste
y_prob_B1 = gb_B1.predict_proba(X_test_raw)[:, 1]
y_pred_B1 = (y_prob_B1 >= 0.5).astype(int)

print("\n=== Évaluation de GB_B1 sur le jeu de test ===")
...
print("\nRapport de classification (GB_B1) :")
